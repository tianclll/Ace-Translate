...
public:
    ...
    /** @brief 初始化模型 */
    bool init(const std::string& model_path, const std::string& tokens_path, bool use_gpu);
...
private:
    ...
    /** @brief CTC 贪婪解码 */
    std::string ctcDecode(const int64_t* logits, int time_steps, int vocab_size);
